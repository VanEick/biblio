...
<html>
    ...
    <body>
      ...
      <!--<form method="post" name="CMCICFormulaire" target="_top" action="https://paiement.creditmutuel.fr/test/recredit_paiement.cgi">-->
      <form method="post" name="CMCICFormulaire" target="_top" action="https://ssl.paiement.cic-banques.fr/test/paiement.cgi">
